...
The original SANER 2026 replication package is available in this repository. The TSE journal extension artifacts have been added under [`TSE_Extension/Refactoring`](TSE_Extension/Refactoring), and will continue to be updated as the manuscript progresses.
...
The LLM-based refactoring artifacts for the journal extension are available under [`TSE_Extension/Refactoring`](TSE_Extension/Refactoring):
